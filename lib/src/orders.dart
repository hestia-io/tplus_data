              ...
              'RDRecordDetails': {
                ...
                'rows': order.snippet.lineItems
                  ...
                  return [
                    ...
                    item.product.price.value, // '656', // Price
                    '${item.quantityShipped * double.parse(item.product.price.value)}', // '21648.00', // Amount
                    '${item.product.taxRate / 100}', // '0.17', // TaxRate
